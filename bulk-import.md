...
| mappingFields       | <p>javascript object containing field names in destination tables and thier mapping with the input data coming from the border table. Field types must be identical.</p><p>Example:</p><p>{</p><p>  destField1: "borderTableFieldA",</p><p>  ...</p><p>}</p>                                                                  |
| commitSize          | in case of a very large result set, commit is essential after a block of data written; e.g. 1000                                                                                                                                                                                                                              |
