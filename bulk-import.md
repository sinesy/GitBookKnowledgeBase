...
| fromRowId           | field name in the first border table, used to identify a single record to update as an record with error, in case of duplicate keys (used only thr "uniqueKeys" property has been filled in)                                                               |
